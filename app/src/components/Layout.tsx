    ...
    <div className="layout">
      ...
      <nav className="sidebar">
        ...
        <div className="nav-links">
          ...
          <div style={{ position: 'relative', borderBottom: '1px solid var(--border)', margin: '0 12px 8px' }}>
            <div style={{ position: 'absolute', bottom: '-8px', left: '50%', transform: 'translateX(-50%)', fontSize: '11px', opacity: 0.4, background: '#0c0b09', padding: '0 10px', whiteSpace: 'nowrap' }}>
